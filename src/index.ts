class Carousel {
    carouselSlide: HTMLElement | null;
    dotsContainer: HTMLElement | null;
    selectionButtons: HTMLElement | null;
    index: number;
    images: HTMLImageElement[];
    icons: HTMLElement[];
  

    constructor(carouselSelector: string, dotsContainerSelector: string, selectionButtonsSelector: string) {
    ...
    showSlide() {
        this.images.forEach((image, i) => {
            ...
            if (i === this.index) image.classList.add('animation');
            else image.classList.remove('animation');
        });
    }
